...
#pygame doesn't have a way to represent scores
...
class Pipe(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        #destroys the pipes that move off the screen
        #this is primarily for memory efficiency
...
button = Button(screen_width // 2 - 50, screen_height // 2 - 75, button_img)
...
while run:
    ...
    #check for game over and reset button
    if game_over == True:
        if button.draw() == True:
            game_over = False
            score = reset_game()
